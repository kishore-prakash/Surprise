...
public class Screen11 extends Activity implements View.OnClickListener {

    private final String TAG = Screen11.class.getName();
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonYes:
                switch (question.getText().toString()) {
                    ...
                    case "Lock Madla?":
                        Toast.makeText(this, "Answer this to finish.", Toast.LENGTH_LONG).show();
                        startActivity(intent);
                        break;
